...
function ISSLocation() {
  ...
  useTimer(fetchISSLocation, TWO_SECONDS); // Usando o hook customizado.

  useEffect(() => {
    document.title = new Date().toLocaleString(); // Usando o useEffect como componentDidUpdate, sempre que o componente for atualizado ...
  });
